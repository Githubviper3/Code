...
from Buttons import EasyButton
from MyUtils import blit_line
from MyColours import red,orange

class Game:
    def __init__(self):
        self.wait =0
        pygame.init()
        self.screen = pygame.display.set_mode((640, 360),pygame.SCALED) #640,360
    ...
    def run(self):
        ...
        while True:
            ...
            if self.Paused:
                ...
                self.background.render(self.display, offset=render_scroll,blur=True)
                self.tilemap.render(self.display, offset=render_scroll,blur=True)
                ...
                if self.Endlevel:
                    ...
                    if self.timegap >= 3*60:
                        ...
                        self.level += 1
                        if self.level > len(os.listdir("Maps")):
